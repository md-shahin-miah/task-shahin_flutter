...
import 'package:shahin_appify_task/config/image_assets.dart';
import 'package:shahin_appify_task/views/screens/auth/login_screen/login_screen_view_model.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          ...
          //     image: AssetImage('assets/images/centre_cir.png'),
          //     fit: BoxFit.cover,
          //   ),
          // ),
          child: Column(
